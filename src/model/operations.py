...
OPS = {
    ...
    # 'rcab': lambda C, stride, affine: RCAB( C, 3, 3,bias=True, bn=False, act=nn.ReLU(True), res_scale=1),
    ...
    # 'deconvolution':lambda C, stride, affine: nn.ConvTranspose2d(C, C,kernel_size=3,stride=stride, padding=1),
